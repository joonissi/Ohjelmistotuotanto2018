...
Syynä tälle on se, että oletusarvoisesti gradlen _run_-task ei liitä terminaalia systeemin "inputvirtaan". Asia saadaan korjautumaan lisäämällä tiedostoon _build.gradle_ seuraava: 
